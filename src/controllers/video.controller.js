...
const videoUploadOnCloud = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new APIResponse(200, resData, "Video uploaded successfully"));
});
...
const rejectVideo = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new APIResponse(200, "Video Successfully Rejected."));
});

export { videoUploadOnCloud, getVideo, getVideoList, rejectVideo };
